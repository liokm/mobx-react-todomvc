...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoStore = __webpack_require__(3);

	var _TodoStore2 = _interopRequireDefault(_TodoStore);

	var _ViewStore = __webpack_require__(7);
	...
	var todoStore = _TodoStore2.default.fromJS(JSON.parse(window.localStorage.getItem('today')) || []);
	var viewStore = new _ViewStore2.default();

	todoStore.subscribeStorage();

	var root = document.getElementById('main-content').appendChild(document.createElement('div'));
	root.className = 'todoapp';

	debugger;
	console.log('No?');

	_reactDom2.default.render(_react2.default.createElement(_todoApp2.default, { todoStore: todoStore, viewStore: viewStore }), root);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoModel = __webpack_require__(5);
	...
	var TodoStore = (_class = function () {
		...
		_createClass(TodoStore, [{
			...
			value: function subscribeStorage() {
				var _this = this;

				(0, _mobx.autorun)(function () {
					var todos = _this.toJS();
					if (_this.subscribedStorage !== true) {
						_this.subscribedStorage = true;
						return;
					}
			...
			value: function archieve() {
				...
				window.localStorage.setItem(getDate(d), JSON.stringify(this.todos.filter(function (x) {
					return x.completed;
				}).map(function (x) {
					return x.toJS();
				})));
			...
			value: function subscribeServerToStore(model) {
				var _this2 = this;

				(0, _mobx.autorun)(function () {
					var todos = _this2.toJS();
					if (_this2.subscribedServerToModel !== true) {
						_this2.subscribedServerToModel = true;
						return;
					}
					fetch('/api/todos', {
						method: 'post',
			...
			value: function addTodo(title) {
				this.todos.push(new _TodoModel2.default(this, title, false, Date.now()));
			}
		}, {
			key: 'toggleAll',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoModel = (_class = function () {
		function TodoModel(store, title, completed, createdAt) {
		...
		_createClass(TodoModel, [{
			...
			key: 'fromJS',
			value: function fromJS(store, arr) {
				return new (Function.prototype.bind.apply(TodoModel, [null].concat([store], _toConsumableArray(arr))))();
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewStore = (_class = function ViewStore() {
		...
		_initDefineProp(this, 'datetime', _descriptor3, this);

		this.setDatetime = function () {
			_this.datetime = new Date().toLocaleString();
			setTimeout(_this.setDatetime, 1000);
		};
	...
	}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, 'datetime', [_mobx.observable], {
		enumerable: true,
		initializer: null
	})), _class);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mobxReact = __webpack_require__(166);

	var _director = __webpack_require__(168);

	var _todoEntry = __webpack_require__(169);

	var _todoEntry2 = _interopRequireDefault(_todoEntry);

	var _todoOverview = __webpack_require__(170);

	var _todoOverview2 = _interopRequireDefault(_todoOverview);

	var _todoFooter = __webpack_require__(172);
	...
	var TodoApp = (0, _mobxReact.observer)(_class = function (_React$Component) {
		...
		_createClass(TodoApp, [{
			...
			value: function render() {
				...
				var todoStore = _props.todoStore;
				var viewStore = _props.viewStore;
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'h3',
							{ style: { color: '#aaa', textAlign: 'center', paddingTop: '1rem' } },
							viewStore.datetime
						),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	     ...
	     */
	    if (true) {
	        module.exports = mrFactory(__webpack_require__(4), __webpack_require__(10), __webpack_require__(167));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoEntry = (0, _mobxReact.observer)(_class = function (_React$Component) {
		...
		function TodoEntry() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(TodoEntry)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleNewTodoKeyDown = function (event) {
				...
				var val = _reactDom2.default.findDOMNode(_this.refs.newField).value.trim();

				if (val) {
					_this.props.todoStore.addTodo(val);
					_reactDom2.default.findDOMNode(_this.refs.newField).value = '';
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoOverview = (0, _mobxReact.observer)(_class = function (_React$Component) {
		...
		function TodoOverview() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(TodoOverview)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.toggleAll = function (event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FocusEndInput = function (_React$Component) {
		_inherits(FocusEndInput, _React$Component);

		function FocusEndInput() {
			_classCallCheck(this, FocusEndInput);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(FocusEndInput).apply(this, arguments));
		}

		_createClass(FocusEndInput, [{
			key: 'focusEnd',
			value: function focusEnd(inputField) {
	...
	var TodoItem = (0, _mobxReact.observer)(_class = function (_React$Component2) {
		_inherits(TodoItem, _React$Component2);

		function TodoItem(props, context) {
			_classCallCheck(this, TodoItem);

			var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoItem).call(this, props, context));

			_this3.handleSubmit = function (event) {
				var val = _this3.state.editText.trim();
				if (val) {
					_this3.props.todo.setTitle(val);
					_this3.setState({ editText: val });
				} else {
					_this3.handleDestroy();
				}
				_this3.props.viewStore.todoBeingEdited = null;
			};

			_this3.handleDestroy = function () {
			...
			_this3.handleEdit = function () {
				...
				_this3.props.viewStore.todoBeingEdited = todo;
				_this3.setState({ editText: todo.title });
			};

			_this3.handleKeyDown = function (event) {
				if (event.which === ESCAPE_KEY) {
					_this3.setState({ editText: _this3.props.todo.title });
					_this3.props.viewStore.todoBeingEdited = null;
			...
			_this3.handleChange = function (event) {
				_this3.setState({ editText: event.target.value });
			};

			_this3.handleToggle = function () {
				_this3.props.todo.toggle();
			};

			_this3.state = { editText: props.todo.title };
			return _this3;
		}
		...
		_createClass(TodoItem, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'li',
					{ className: [todo.completed ? "completed" : "", todo === viewStore.todoBeingEdited ? "editing" : ""].join(" ") },
					_react2.default.createElement(
						'div',
						{ className: 'view' },
						_react2.default.createElement('input', {
					...
					this.props.viewStore.todoBeingEdited === todo ? _react2.default.createElement(FocusEndInput, {
						className: 'edit',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoFooter = (0, _mobxReact.observer)(_class = function (_React$Component) {
		...
		function TodoFooter() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(TodoFooter)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.clearCompleted = function () {
				_this.props.todoStore.clearCompleted();
			}, _this.archieve = function () {
				_this.props.todoStore.archieve();
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}
